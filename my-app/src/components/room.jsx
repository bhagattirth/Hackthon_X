...
class Room extends Component {
    ...
    constructor(props) {
      ...
      this.crabtree = this.crabtree.bind(this);
            ...
            for(let i = 0;i<elems.length;++i){
                elems[i].addEventListener("click",
                    () => {
                      ...
                      return <div>{this.crabtree(this.props)}</div>
                      // switch(elems[i].innerHTML) {
                      //   case "Crabtree": this.crabtree(); break;
                      //   case 'Dwight': this.Dwight(); break;
                      //   case 'Hamlin': this.Hamlin(); break;
                      //   case 'Leach': this.Leach(); break;
                      //   case 'Mary': this.Mary(); break;
                      //   case 'Lyon': this.Lyon(); break;
                      //   case 'Knowlton': this.Knowlton(); break;
                      //   case 'Johnson': this.Johnson(); break;
                      //   case 'Lewis': this.Lewis(); break;
                      //   case 'Thatcher': this.Thatcher(); break;
                      //   case 'Butterfield': this.Butterfield(); break;
                      //   case 'Gorman': this.Gorman(); break;
                      //   case 'Van Meter': this.vanMeter(); break;
                      //   case 'Wheeler': this.Wheeler(); break;
                      //   case 'Baker': this.baker(); break;
                      //   case 'Brett': this.Brett(); break;
                      //   case 'Brooks': this.Brooks(); break;
                      //   case 'Chadbourne': this.Chadbourne(); break;
                      //   case 'Greenough': this.Greenough(); break;
                      //   case 'Brown': this.Brown(); break;
                      //   case 'Sylvan': this.Sylvan(); break;
                      //   case 'McNamara': this.McNamara(); break;
                      //   case 'Dickinson': this.Dickinson(); break;
                      //   case 'Field': this.Field(); break;
                      //   case 'Grayson': this.Grayson(); break;
                      //   case 'Webster': this.Webster(); break;
                      //   case 'Cance': this.Cance(); break;
                      //   case 'Coolidge': this.Coolidge(); break;
                      //   case 'Crampton': this.Crampton(); break;
                      //   case 'Emerson': this.Emerson(); break;
                      //   case 'James': this.James(); break;
                      //   case 'John Adams': this.johnAdams(); break;
                      //   case 'John Quincy Adam': this.JQA(); break;
                      //   case 'Kennedy': this.Kennedy(); break;
                      //   case 'MacKimmie': this.MacKimmie(); break;
                      //   case 'Melville': this.Melville(); break;
                      //   case 'Moore': this.Moore(); break;
                      //   case 'Patterson': this.Patterson(); break;
                      //   case 'Pierpont': this.Pierpont(); break;
                      //   case 'Prince': this.Prince(); break;
                      //   case 'Thoreau': this.Thoreau(); break;
                      //   case 'Washington': this.washington(); break;
                      //   }
